...
class TipCalculator:
    def __init__(self) -> None:
        ...
        twenty_percent_tip = Radiobutton(
            window, text="25%", variable=self.tip_percent, value=20
        )
        ...
        calculate_btn = Button(
            window, text="Calculate", bg="green", fg="white", command=self.calculate
        )
        calculate_btn.grid(column=1, row=7, padx=15)

        clear_btn = Button(
            window, text="Clear", bg="black", fg="white", command=self.clear
        )
